      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-bold text-white text-lg">
                Scholar<span className="text-teal-300">Chain</span>
              </span>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed mb-6 max-w-xs">
              A trustless grant pool protocol where every fund, vote, and payout
              is publicly verifiable on Ethereum.
            </p>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-slate-500">
            © 2025 ScholarChain Protocol. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
